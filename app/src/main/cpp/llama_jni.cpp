...
Java_com_qali_aterm_llm_LocalLlamaModel_generateNative(JNIEnv *env, jobject thiz, jstring prompt, jint maxResponseLength) {
    ...
    try {
        ...
        llama_sampler_chain_add(smpl, llama_sampler_init_penalties(64, DEFAULT_REPEAT_PENALTY, 0.0f, 0.0f)); // Add repeat penalty (last_n=64, freq and presence penalties disabled)

...
import com.qali.aterm.agent.utils.safeLiteralReplace
import com.qali.aterm.agent.utils.createPatch
import com.qali.aterm.agent.utils.getDiffStat
import com.qali.aterm.agent.utils.FileCoherenceManager
import com.qali.aterm.agent.utils.AutoErrorDetection
import com.qali.aterm.agent.utils.FuzzyStringMatcher
import com.qali.aterm.agent.utils.EditFailureMonitor
import java.io.File
...
class EditToolInvocation(
    ...
    override suspend fun execute(
        ...
        return try {
            ...
            // Use FileCoherenceManager for atomic write during concurrent operations

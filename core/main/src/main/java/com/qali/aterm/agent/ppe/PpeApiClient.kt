    ...
    suspend fun callApi(
        ...
        return withContext(Dispatchers.IO) {
            ...
            if (currentProvider == com.qali.aterm.api.ApiProviderType.BUILTIN_LOCAL) {
                ...
                val isCodeTask = Regex("""\b(code|blueprint|function|class|file|generate|create|write|implement|build|html|css|js|javascript|python|java|kotlin|typescript|react|vue|angular|component|page|app|website|web|youtube|replicat)\b""", RegexOption.IGNORE_CASE).containsMatchIn(allText)
